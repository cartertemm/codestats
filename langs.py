...
language("ApacheConf", [".apacheconf", ".vhost"], associated_files=[".htaccess", "apache2.conf", "httpd.conf"])
...
language("HTTP", [".http"])
language("INI", [".ini", ".cfg", ".lektorproject", ".prefs", ".pro", ".properties"], associated_files=[".editorconfig", ".gitconfig", "buildozer.spec"])
language("Inno Setup", [".iss"])
language("java", [".java"])
language("java server pages", [".jsp"])
language("javascript", [".js", "._js", ".bones", ".es", ".es6", ".frag", ".gs", ".jake", ".jscad", ".jsfl", ".jsm", ".mjs", ".njs", ".pac", ".sjs", ".ssjs", ".xsjs", ".xsjslib"])
language("jaws script", [".jsb", ".jss"])
language("LOLCode", [".lol"])
language("Linux Kernel Module", [".mod"])
language("lua", [".lua", ".wlua"])
language("makefile", [".mak", ".make", ".mk", ".mkfile"], associated_files=["BSDmakefile", "GNUmakefile", "Kbuild", "Makefile", "Makefile.am", "Makefile.boot", "Makefile.frag", "Makefile.in", "Makefile.inc", "Makefile.wat", "makefile", "makefile.sco", "mkfile"])
language("markdown", [".md", ".markdown", ".mdown", ".mdwn", ".mkd", ".mkdn", ".mkdown", ".ronn", ".workbook"], parent_lang="text")
language("moo", [".moo"])
...
language("Perl", [".pl", ".al", ".perl", ".plx", ".pm"], associated_files=["Makefile.PL", "rexfile", "ack", "cpanfile"])
language("Powershell", [".ps1", ".psd1", ".psm1"])
language("PureBasic", [".pb", ".pbi"])
language("python", [".py", ".pyw", ".py2", ".py3", ".pyi", ".pip"], associated_files=[".gclient", "BUCK", "BUILD", "BUILD.bazel", "SConscript", "SConstruct", "Snakefile", "WORKSPACE", "wscript"])
language("Regular Expression", [".regexp", ".regex"])
language("ruby", [".rb", ".builder", ".eye", ".gemspec", ".god", ".jbuilder", ".mspec", ".pluginspec", ".podspec", ".rabl", ".rake", ".rbuild", ".rbw", ".rbx", ".ruby", ".thor", ".watchr"], associated_files=[".irbrc", ".pryrc", "Appraisals", "Berksfile", "Brewfile", "Buildfile", "Capfile", "Dangerfile", "Deliverfile", "Fastfile", "Gemfile", "Gemfile.lock", "Guardfile", "Jarfile", "Mavenfile", "Podfile", "Puppetfile", "Rakefile", "Snapfile", "Thorfile"])
language("rust", [".rs", ".rs.in"])
language("shell script", [".sh", ".bash", ".ksh", ".sh.in", ".tmux", ".zsh"], associated_files=[".bash_logout", ".bash_profile", ".bashrc", ".login", ".profile", ".zlogin", ".zlogout", ".zprofile", ".zshenv", ".zshrc"])
language("swift", [".swift"])
language("visual basic", [".vb", ".bas", ".cls", ".frm", ".frx", ".vba", ".vbhtml", ".vbs"])
